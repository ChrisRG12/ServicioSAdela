...
Route::group(['middleware' => 'usuario'], function(){
    ...
    Route::get('misComentarios/{id}', 'funcionesBD@misComentarios', function(){
	    return view('VistaMisComentarios');
    })->name('misComentarios');
});
...
Route::group(['middleware' => 'administrador'], function(){
    ...
    Route::get('avisosCargados/{id}', 'funcionesBD@misAvisos' ,function() {
        return view('Administrador.VistaMisAvisos');
    })->name('avisosCargados');
    Route::get('CargaVideo', function(){
	    return view('Administrador.VistaCargaVideos');
    })->name('CargaVideo');
    Route::get('videosCargados/{id}', 'funcionesBD@videosCargados', function(){
...
Route::put('actualizarAviso', 'funcionesBD@actualizarAviso')->name('actualizarAviso');
