		...
		<table class="table table-striped table-bordered tablas" id="tabla_misavisos" >
		   ...
		   <tbody>
		      ...
		      <tr>
				...
				<td><button class="btn btn-primary btn_actualizar_aviso" data-toggle="tooltip" data-placement="top" title="Actualizar aviso" data-id="{{$aviso->id_aviso}}" data-usuario="{{$aviso->id_usuario}}"><i class="fa fa-refresh" aria-hidden="true"></i></button><span style="color:white">.</span><button class="btn btn-danger btn_eliminar_aviso" data-toggle="tooltip" data-placement="top" title="Eliminar aviso" data-id="{{$aviso->id_aviso}}" data-nombre="{{$aviso->titulo}}" data-usuario="{{$aviso->id_usuario}}"><i class="fa fa-trash" aria-hidden="true"></i></button></td>
			  </tr>
			@endforeach
		   </tbody>
		</table>
