      ...
      <div class="card bg-light tituloTabla"><h3 class="card-title">Videos cargados</h3></div>
		 ...
		 <body>
            ...
            <td>{{$video->fecha_carga}}</td>
		        ...
		        <td><div style="text-align: center;"><button class="btn btn-primary btn_actualizar_video" data-id="{{session()->get('id')}}" data-video="{{$video->id_video}}" data-toggle="tooltip" data-placement="top" title="Actualizar video" ><i class="fa fa-refresh" aria-hidden="true"></i></button><span style="color:white">.</span><button class="btn btn-danger btn_eliminar_video" data-toggle="tooltip" data-placement="top" title="Eliminar video" data-usuario="{{$video->id_usuario}}" data-id="{{$video->id_video}}"><i class="fa fa-trash" aria-hidden="true"></i></button></div></td>
		    </tr>
		    @endforeach
		 </body>
   	     </table>
