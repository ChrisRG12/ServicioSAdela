...
@section('content')
 <body>
   <div>
         <div class="card bg-light contenl">
            ...
            <div class="card-body">
            	<form method="post" action="{{route('usuarios.store')}}">
            	   ...
            	   <div class="form-group">
            	      ...
            	      <input type="password" placeholder="Ingrese una contraseña" class="form-control" id="passregistro" name="password">
                      @if ($errors->has('password'))
                         <div class="alert alert-danger" role="alert">
                            {{ $errors->first('password') }}
                         </div>
                      @endif
                      <div><input type="checkbox" id="checkpass" title="Mostrar contraseña"> &nbsp;Mostrar Contraseña</div>
            	   </div>
            	   <div class="form-group">
            	      <label>Repetir contraseña:</label>
            	      <input type="password" placeholder="Ingrese de nuevo la contraseña" class="form-control" id="passrepetir" name="repetir">
                      @if ($errors->has('repetir'))
                         <div class="alert alert-danger" role="alert">
                            {{ $errors->first('repetir') }}
                         </div>
                      @endif
                      <div><input type="checkbox" id="checkrepetir" title="Mostrar contraseña"> &nbsp;Mostrar Contraseña</div>
            	   </div>
