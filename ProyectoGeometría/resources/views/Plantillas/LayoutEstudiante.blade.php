...
<head>
    ...
    <script src="https://kit.fontawesome.com/e073cc066f.js" crossorigin="anonymous"></script>
       ...
       <li class="nav-item dropdown">
        ...
        <!--Ecuaciones Diferenciales-->
         ...
         <!--Probabilidad y estadística-->
           ...
           <!--Comentarios-->
           <li class="nav-item dropdown">
               <a class="nav-link dropdown-toggle dropleft" href="javascript:void(0)" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:azure">
               Comentario <i class="fa fa-comments" aria-hidden="true"></i>
               </a>
               <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="{{route('vistaComentarios')}}">Nuevo comentario </a>
                  <a class="dropdown-item" href="<?php echo route('misComentarios', session()->get("id")); ?>">Mis comentarios </a>
               </div>
            </li>
           <!--Usuario-->
            <li class="nav-item dropdown">
