...
class funcionesBD extends Controller
{
    ...
    public function insertarComentario(validacionesComentarios $request){
          ...
          return redirect('misComentarios/'.$id.'')->with('mensaje', 'mensaje');
    }
    ...
    public function misComentarios($id){
        $consulta=DB::table('tcomentarios')
    ...
    public function registroContenido(validacionesContenido $request){
        ...
        \Storage::disk('local')->put($nom_imagen,  \File::get($imagen));
          return redirect('avisosCargados/'.$id.'')->with('mensaje', 'mensaje');
    }
    ...
    public function misAvisos($id){
        $consulta=DB::table('tavisos')
                  ->select('id_aviso', 'id_usuario' ,'titulo', 'descripcion', 'imagen')
                  ->where('id_usuario', $id)
                  ->get();
    ...
    public function actualizarAviso(validacionesEditarAviso $request){
         ...
         $id=$request->input('id_user');
         return redirect('avisosCargados/'.$id.'')->with('actualizado', 'mensaje');
    }
    ...
    public function eliminarAviso(Request $request){
           ...
           return redirect('avisosCargados/'.$id.'')->with('eliminado', 'mensaje');
    ...
    public function cargarVideo(validacionesVideo $request){
          ...
          return redirect('videosCargados/'.$id.'')->with('cargado', 'mensaje');
    }
    //Función para mostrar los videos de cada materia
    public function consultaVideos($id){
      $consulta=DB::table('tvideos')
                ->join('tmateria', 'tvideos.id_materia', '=', 'tmateria.id_materia')
                ->select('tvideos.id_video','tvideos.titulo', 'tvideos.descripcion', 'tvideos.video', 'tmateria.nombre_materia', 'tvideos.tipo')
    ...
    public function videosCargados($id){
         $consulta=DB::table('tvideos')
                   ->join('tmateria', 'tvideos.id_materia', '=', 'tmateria.id_materia')
                   ->select('tvideos.id_video','tvideos.id_usuario','tvideos.titulo', 'tvideos.descripcion', 'tmateria.nombre_materia','tvideos.tipo', 'tvideos.video', 'tvideos.fecha_carga')
                   ->where('id_usuario', $id)
                   ->get();
    ...
    public function eliminarVideo(Request $request){
        ...
        return redirect('videosCargados/'.$id.'')->with('eliminado', 'mensaje');
    }
    ...
    public function actualizarVideo(validacionesEditarVideo $request){
        ...
        return redirect('videosCargados/'.$id.'')->with('actualizado', 'mensaje');
    }
}
